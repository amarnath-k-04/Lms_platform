...
const toggleSection=(index)=>{
 setOpenSections((prev)=>(
  ...
  return courseData ? (
    <>
     <div className='flex md:flex-row flex-col-reverse gap-28 relative items-start justify-between md:px-36  px-8 md:pt-30 pt-20 text-left'>
      ...
      {/* review and rating */}
       <div className='flex items-center space-x-2 pt-3 pb-sm'>
               ...
               <p className='text-sm'>Course By <span className='text-blue-600 underline'>Acadify</span></p>
