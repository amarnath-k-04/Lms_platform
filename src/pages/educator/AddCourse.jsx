  ...
  return (
    <>
     <div className='h-screen overflow-scroll flex flex-col items-start justify-between md:p-8 md:pb-0 p-4 pt-8 pb-0'>
      <form onClick={handleSubmit} className='flex flex-col gap-4 max-w-md w-full text-gray-500' action="">
        <div className='flex flex-col gap-1'>
          <p>Course Title</p>
          <input onChange={e=>setCourseTitle(e.target.value)} type=" text" placeholder='Type here' className='outline-none nmd:py-2.5 py-2 px-3 rounded border border-gray-500' />
        </div>
        <div className='flex flex-col gap-1'>
