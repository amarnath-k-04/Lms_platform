...
function CoursesSection() {
  ...
  return (
    ...
    <div className='py-16 md:px-40 px-8'>
      ...
      <p className='text-sm md:text-base text-gray-500 mt-3 mb-7'>Discover our top-rated courses across various categories. From coding and design to business <br /> and wellness, our courses are crafted to deliver results.</p>
